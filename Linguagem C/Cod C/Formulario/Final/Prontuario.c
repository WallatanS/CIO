...
/*void login ()
{
    char usu[40], usuario[40];
    long long  sen, senha;
    strcpy(usuario, "wallatan");
    senha == 123;
    printf("LOGIN\n");
    printf("Usuario:\n");
    setbuf(stdin,NULL);
...
void cadapaci()
{
  ...
  if(mod==1)
  {
    ...
    scanf("%d",&numreg);
    prmt = (paci*) realloc(prmt, numreg * sizeof(paci));
    ARQUIVO = fopen("Paciente.dat", "ab+");
    for (cont = 0; cont < numreg; cont++){
      ...
      pacie.mod = 1;
      fwrite(&pacie, sizeof(struct Paciente), 1, ARQUIVO);
    }
    fclose(ARQUIVO);
  }
  else
...
void cadaprotu()
{
  ...
  int mod, cont, numreg;
  prontu *prmt;
  ARQUIVO = fopen("Prontuario.dat","rt");
  if(ARQUIVO == NULL)
  {
    mod=0;
  }
  ...
  if(mod==1)
  {
    ...
    scanf("%d", &numreg);
    prmt = (prontu*) realloc(prmt, numreg * sizeof(prontu));
    ...
    for (cont = 0; cont < numreg; cont++)
    {
      ...
      scanf("%[^\n]s",&reg.observa);
      reg.mod = 1;
      fwrite(&reg, sizeof(struct Prontuario), 1, ARQUIVO);
    }
    fclose(ARQUIVO);
  } else
  {
    ...
    printf("NUMERO DE PRONTUARIOS A SEREM CADASTRADOS:\n");
    scanf("%d", &numreg);
    prmt = (prontu*) malloc(numreg * sizeof(prontu));
    ARQUIVO= fopen("Prontuario.dat", "ab+");
    for (cont = 0; cont < numreg; cont++)
    {
      relahospita();
...
void cadamed()
{
  ...
  if(mod==1)
  {
    ...
    scanf("%d",&numreg);
    prmt = (medi*) realloc(prmt, numreg * sizeof(medi));
    ARQUIVO = fopen("Medico.dat", "ab+");
    for (cont = 0; cont < numreg; cont++){
      setbuf(stdin,NULL);
      printf("Nome:\n");
      scanf("%[^\n]s",&reg.nome);
      ...
      scanf("%i",&reg.forma);
      reg.mod = 1;
      fwrite(&reg, sizeof(struct Medico), 1, ARQUIVO);
    }
    fclose(ARQUIVO);
  }
  else
...
void cadahosp()
{
  ...
  if(mod==1)
  {
    ...
    scanf("%d",&numreg);
    prmt = (hospi*) realloc(prmt, numreg * sizeof(hospi));
    ARQUIVO = fopen("Hospital.dat", "ab+");
    for (cont = 0; cont < numreg; cont++){
      fflush(stdin);
      printf("Nome:\n");
      scanf("%[^\n]s",&reg.nome);
      ...
      scanf("%f", &reg.numero);
      reg.mod = 1;
      fwrite(&reg, sizeof(struct Hospital), 1, ARQUIVO);
    }
    fclose(ARQUIVO);
  }
  else
...
void cadaforma()
{
  ...
  if(mod==1)
  {
    ...
    scanf("%d",&numreg);
    prmt = (form*) realloc(prmt, numreg * sizeof(form));
    ARQUIVO = fopen("Formacao.dat", "a");
    for (cont = 0; cont < numreg; cont++){
      setbuf(stdin,NULL);
      printf("Nome:\n");
      scanf("%[^\n]s",&reg.nome);
      ...
      scanf("%i", &reg.numero);
      reg.mod = 1;
      fwrite(&reg, sizeof(struct Formacao), 1, ARQUIVO);
    }
    fclose(ARQUIVO);
  }
  else
...
void relapaci()
{
  ...
  {
    fclose(ARQUIVOFUNC);
    printf("Sem Arquivo Para Relatorio\n");
    system("pause");
  }else
  {
    fclose(ARQUIVO);
    ARQUIVOFUNC = fopen("Paciente.dat", "rb");
    fseek(ARQUIVOFUNC, 0L, SEEK_SET);
...
void relaprontu()
{
  ...
  prontu reg;
  int cont=0;
  ARQUIVOFUNC = fopen("Prontuario.dat", "rb");
  if (ARQUIVOFUNC == NULL)
  {
    fclose(ARQUIVOFUNC);
    printf("Sem Arquivo Para Relatorio\n");
...
void relamedico()
{
  ...
  medi reg;
  int cont=0;
  ARQUIVOFUNC = fopen("Medico.dat","rb");
  if (ARQUIVOFUNC == NULL)
  {
    fclose(ARQUIVOFUNC);
...
void relahospita()
{
  ...
  hospi reg;
  int cont=0;
  ARQUIVOFUNC = fopen("Hospital.dat", "rb");
  if (ARQUIVOFUNC == NULL)
  {
    fclose(ARQUIVOFUNC);
    printf("Sem Arquivo Para Relatorio\n");
...
void relaforma()
{
  ...
  form reg;
  int cont=0;
  ARQUIVOFUNC = fopen("Formacao.dat", "rb");
  if (ARQUIVOFUNC == NULL)
  {
    fclose(ARQUIVOFUNC);
    printf("Sem Arquivo Para Relatorio\n");
...
int locapaci()
{
  ...
  int posi=0, loca=-1;
  long long var;
  ARQUIVOFUNC = fopen("Paciente.dat","ab+");
  setbuf(stdin,NULL);
  printf("CPF DO PACIENTE:\n");
  scanf("%lld", &var);
  while((!feof(ARQUIVOFUNC))&&(loca==-1))
  {
    fread(&reg, sizeof(struct Paciente), 1, ARQUIVOFUNC);
    if (!feof(ARQUIVOFUNC))
    {
...
int locaprontu()
{
  ...
  int posi=0, loca=-1;
  long long var;
  ARQUIVOFUNC = fopen("Prontuario.dat","ab+");
  setbuf(stdin,NULL);
...
int locamed()
{
  ...
  int posi=0, loca=-1;
  char var[30];
  ARQUIVOFUNC = fopen("Medico.dat","ab+");
  setbuf(stdin,NULL);
...
int locaforma()
{
  ...
  int posi=0, loca=-1;
  long long var;
  ARQUIVOFUNC = fopen("Formacao.dat","ab+");
  setbuf(stdin,NULL);
...
int locahosp()
{
  ...
  int posi=0, loca=-1;
  long long var;
  ARQUIVOFUNC = fopen("Hospital.dat","ab+");
  setbuf(stdin,NULL);
  printf("INFORME O NUMERO DO HOSPITAL:\n");
  scanf("%lld", &var);
  while((!feof(ARQUIVOFUNC))&&(loca==-1))
  {
    fread(&reg, sizeof(struct Hospital), 1, ARQUIVOFUNC);
...
int consulpaci()
{
  ...
  {
    ARQUIVOFUNC = fopen("Paciente.dat","rb+");
    fseek(ARQUIVOFUNC,posi*sizeof(struct Paciente),SEEK_SET);
    fread(&reg , sizeof(struct Paciente) , 1 , ARQUIVOFUNC);
...
int consulprotu()
{
  ...
  {
    ARQUIVOFUNC = fopen("Prontuario.dat","rb+");
    fseek(ARQUIVOFUNC,posi*sizeof(struct Prontuario),SEEK_SET);
    fread(&reg , sizeof(struct Prontuario) , 1 , ARQUIVOFUNC);
...
int consulmed()
{
  ...
  {
    ARQUIVOFUNC = fopen("Medico.dat","rb+");
    fseek(ARQUIVOFUNC,posi*sizeof(struct Medico),SEEK_SET);
    fread(&reg, sizeof(struct Medico) , 1 , ARQUIVOFUNC);
    parame = reg.forma;
    consulforma2();
...
int consulhosp()
{
  ...
  {
    ARQUIVOFUNC = fopen("Hospital.dat","rb+");
    fseek(ARQUIVOFUNC,posi*sizeof(struct Hospital),SEEK_SET);
    fread(&reg , sizeof(struct Hospital) , 1 , ARQUIVOFUNC);
...
int consulforma()
{
  ...
  {
    ARQUIVOFUNC = fopen("Formacao.dat","rb+");
    fseek(ARQUIVOFUNC,posi*sizeof(struct Formacao),SEEK_SET);
    fread(&reg , sizeof (struct Formacao), 1 , ARQUIVOFUNC);
    printf("\nNOME: %s || NUMERO: %i\n",reg.nome, reg.numero);
  }
  fclose(ARQUIVOFUNC);
...
void consulforma2()
{
  ...
  {
    ARQUIVO2 = fopen("Formacao.dat","rb+");
    fseek(ARQUIVO2,posi*sizeof(struct Formacao),SEEK_SET);
    fread(&reg , sizeof (struct Formacao), 1, ARQUIVO2);
    strcpy(func, reg.nome);
    printf("%s\n", func);
  }
  fclose(ARQUIVO2);
}
...
int locaforma2(int posicao)
{
  ...
  int posi=0, loca=-1;
  int var;
  ARQUIVO2 = fopen("Formacao.dat","ab+");
  setbuf(stdin,NULL);
  var = posicao;
  while((!feof(ARQUIVO2))&&(loca==-1))
  {
    fread(&reg, sizeof(struct Formacao), 1, ARQUIVO2);
    if (!feof(ARQUIVO2))
    {
...
void alterpaci()
{
  ...
  {
    fopen("Paciente.dat","rb+");
    fseek(ARQUIVO , pos * sizeof(struct Paciente) , SEEK_CUR);
    fread(&reg , sizeof(struct Paciente) , 1 , ARQUIVO);
    printf("\nALTERAR PACIENTE\n");
    printf("--------------------------\n");
    ...
    scanf("%ld", &reg.rg);
    printf("Contato de Emergencia:\n");
    scanf("%lld", &reg.contemer);
    reg.mod = 1;
    fseek(ARQUIVO , pos * sizeof(struct Paciente) , SEEK_SET);
    if(fwrite(&reg , sizeof(struct Paciente) , 1 , ARQUIVO) != 1)
    {
      printf("\nErro na gravacao\n");
    }
    else
...
void alterprotu()
{
  ...
  {
    fopen("Prontuario.dat","rb+");
    fseek(ARQUIVO , pos * sizeof(struct Prontuario) , SEEK_CUR);
    fread(&reg , sizeof(struct Prontuario) , 1 , ARQUIVO);
    printf("\nALTERAR PRONTUAIRO\n");
    printf("--------------------------\n");
    printf("HOSPITAL: %i\n || PACIENTE: %i\n || MEDICO: %s\n || OBSERVACAO: %s\n", reg.hospital, reg.paciente, reg.medico, reg.observa);
    printf("--------------------------\n");
    ...
    scanf("%[^\n]s",&reg.observa);
    reg.mod = 1;
    fseek(ARQUIVO , pos * sizeof(struct Prontuario) , SEEK_SET);
    if(fwrite(&reg , sizeof(struct Prontuario), 1 , ARQUIVO) != 1)
    {
      printf("\nErro na gravacao\n");
    }
    else
...
void altermed()
{
  ...
  {
    fopen("Medico.dat","rb+");
    fseek(ARQUIVO , pos * sizeof(struct Medico) , SEEK_CUR);
    fread(&reg , sizeof(struct Medico) , 1 , ARQUIVO);
    printf("\nALTERAR MEDICO\n");
    printf("--------------------------\n");
    printf("NOME: %s || CPF: %lld|| RG: %ld || CRM: %s || TELEFONE: %lld || ESPECIALIZACAO: %i \n", reg.nome, reg.cpf, reg.rg, reg.crm, reg.tel, reg.forma);
    printf("--------------------------\n");
    ...
    scanf("%i",&reg.forma);
    reg.mod = 1;
    fseek(ARQUIVO , pos * sizeof(struct Medico) , SEEK_SET);
    if(fwrite(&reg , sizeof(struct Medico), 1 , ARQUIVO) != 1)
    {
      printf("\nErro na gravacao\n");
    }
    else
...
void alterhosp()
{
  ...
  {
    fopen("Hospital.dat","rb+");
    fseek(ARQUIVO , pos * sizeof(struct Hospital) , SEEK_CUR);
    fread(&reg , sizeof(struct Hospital) , 1 , ARQUIVO);
    printf("\nALTERAR HOSPITAL\n");
    printf("--------------------------\n");
    printf("NOME: %s || ENDERECO: %s || ID: %i\n", reg.nome, reg.endereco, reg.numero);
    printf("--------------------------\n");
    ...
    scanf("%f", &reg.numero);
    reg.mod = 1;
    fseek(ARQUIVO , pos * sizeof(struct Hospital) , SEEK_SET);
    if(fwrite(&reg , sizeof(struct Hospital), 1 , ARQUIVO) != 1)
    {
      printf("\nErro na gravacao\n");
    }
    else
...
void alterforma()
{
  ...
  {
    fopen("Formacao.dat","rb+");
    fseek(ARQUIVO , pos * sizeof(struct Formacao) , SEEK_CUR);
    fread(&reg , sizeof(struct Formacao) , 1 , ARQUIVO);
    printf("\nALTERAR FORMACAO\n");
    printf("--------------------------\n");
    ...
    scanf("%i", &reg.numero);
    reg.mod = 1;
    fseek(ARQUIVO , pos * sizeof(struct Formacao) , SEEK_SET);
    if(fwrite(&reg , sizeof(struct Formacao), 1 , ARQUIVO) != 1)
    {
      printf("\nErro na gravacao\n");
    }
    else
